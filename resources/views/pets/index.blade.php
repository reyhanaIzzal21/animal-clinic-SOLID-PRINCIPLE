<x-app>
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-7xl mx-auto p-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
                <h1 class="text-2xl font-semibold text-[#FBA518]">Daftar Hewan Peliharaan</h1>

                <div class="flex gap-4 w-full md:w-auto">
                    <!-- Search Input -->
                    {{-- <div class="relative flex-1 md:flex-initial">
                        <input type="text" name="search" placeholder="Cari pet..."
                    ...
                    <table class="w-full">
                        <thead class="bg-[#FBA518] text-white">
                            <tr>
                                ...
                                <th class="py-4 px-6 text-left">Nama Pet</th>
                                <th class="py-4 px-6 text-left hidden md:table-cell">Jenis</th>
                                <th class="py-4 px-6 text-left hidden sm:table-cell">Usia</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach ($pets as $pet)
                                <tr class="hover:bg-gray-50 transition-all duration-200">
                                    <td class="py-4 px-6">{{ $pet->customer->name }}</td>
                                    <td class="py-4 px-6">{{ $pet->name }}</td>
                                    <td class="py-4 px-6 hidden md:table-cell">{{ $pet->species }}</td>
                                    <td class="py-4 px-6 hidden sm:table-cell">{{ $pet->age }} tahun</td>
                                    <td class="py-4 px-6">
                                        <div class="flex justify-center gap-2">
                                            ...
                                            <button type="button" data-modal-target="deleteModal-{{ $pet->id }}"
                                                data-modal-toggle="deleteModal-{{ $pet->id }}"
    ...
    <!-- Delete modal -->
    @foreach ($pets as $pet)
        <div id="deleteModal-{{ $pet->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-50 sm:p-5">
                    ...
                    <div class="flex justify-center items-center space-x-4">
                        <button data-modal-toggle="deleteModal-{{ $pet->id }}" type="button"
