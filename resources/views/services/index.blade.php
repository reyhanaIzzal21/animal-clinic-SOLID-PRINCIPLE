<x-app>
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-7xl mx-auto p-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
                <h1 class="text-2xl font-semibold text-[#FBA518]">Daftar Layanan</h1>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-[#FBA518] text-white">
                            <tr>
                                <th class="py-4 px-6 text-left">Nama Layanan</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach ($services as $service)
                                <tr class="hover:bg-gray-50 transition-all duration-200">
                                    ...
                                    <td class="py-4 px-6 hidden md:table-cell text-gray-600">
                                    ...
                                    <td class="py-4 px-6">
                                        <div class="flex justify-center gap-2">
                                            ...
                                            <button type="button" data-modal-target="deleteModal-{{ $service->id }}"
                                                data-modal-toggle="deleteModal-{{ $service->id }}"
    ...
    <!-- Delete modal -->
    @foreach ($services as $service)
        <div id="deleteModal-{{ $service->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-50 sm:p-5">
                    ...
                    <div class="flex justify-center items-center space-x-4">
                        <button data-modal-toggle="deleteModal-{{ $service->id }}" type="button"
